...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button l = (Button) findViewById(R.id.button3);
		l.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MainActivity.this,Manifesto.class);
    			startActivity(intent);
			}
		});
		Button lin = (Button) findViewById(R.id.button1);//user login
		//Button lind = (Button) findViewById(R.id.button3);//doctor login
