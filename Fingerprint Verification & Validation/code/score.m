% Matching the tranformed minutiaes

% if the euclidean dist bet the minutiae is less than 15 and the diff between the orientation angles is less than 14
%     the minutiae are taken as equal
% the similarity inde is cal using the formula
