...
% Input is the image and display flag(calls the functions only when necessary argumets are passed)
% and ouput is an array containing the minutiae cordinates.

function [ ret ] = ext_finger( img, display_flag )
%% Checking if the the no of arguments are correct
    if nargin==1; 
        display_flag=0; 
    end
