...
%Read image
frame2 = imread('/home/arwa/Desktop/smai/Project/Dataset/DB1_B/101_1.tif');
...
%Make binary
frame_mean = mean(mean(frame2));
frame2(frame2 < frame_mean) = 0;
frame2(frame2 >= frame_mean) = 1;

%% 

BW3 = bwmorph(frame2,'thin',Inf);
figure, imshow(BW3);
